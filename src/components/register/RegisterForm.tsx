...
const RegisterForm = () => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...data,
      membershipType,
      consent: form.consent instanceof HTMLInputElement ? form.consent.checked : false,
    };
    ...
    return (
      <div className="mx-auto flex max-w-lg flex-col items-center gap-3 rounded-3xl border border-line-strong bg-paper p-10 text-center sm:p-14">
        ...
        <p className="max-w-sm text-sm leading-relaxed text-ink-soft">
          Jazakumullahu khairan for joining MCAN Rivers State — someone from
          the chapter will reach out to you shortly. Check your email for
          confirmation.
        </p>
        <button
          type="button"
      ...
      >
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div className="flex items-start gap-3 sm:col-span-2">
            ...
            />
            <label htmlFor="consent" className="text-xs leading-relaxed text-ink-soft">
              I consent to MCAN Rivers State storing this information to
              process my membership.
            </label>
          </div>
